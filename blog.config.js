...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Liangshuoer', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '叫我liangshuoer', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://m.liangshuoer.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'nas&博客', // 网站关键词 英文逗号隔开

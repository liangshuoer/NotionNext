...
const CONFIG = {
  ...
  STARTER_HERO_TITLE_1: '良朔&晓涵的记录、分享、存储中心', // 英雄区文字
  STARTER_HERO_TITLE_2: 'm.liangshuoer.cn', // 英雄区文字
  // 英雄区两个按钮，如果TEXT留空则隐藏按钮
  STARTER_HERO_BUTTON_1_TEXT: 'nas主入口', // 英雄区按钮
  STARTER_HERO_BUTTON_1_URL: 'http://www.liangshuoer.cn:5244/', // 英雄区按钮
  STARTER_HERO_BUTTON_2_TEXT: 'nas访客入口', // 英雄区按钮
  STARTER_HERO_BUTTON_2_URL: 'http://www.liangshuoer.cn:5244', // 英雄区按钮
 ...
 // STARTER_FOOTER_BLOG_LATEST_TITLE: '最新文章',
  ...
  STARTER_POST_REDIRECT_URL: 'https://m.liangshuoer.cn', // 重定向域名
